// Role: the generated builder for the epistack-competition kernel: builds its v3 store through the real gate from
//   the pure data in communities/epistack-competition/corpus, exactly as build/knowledge-game-build.mjs builds
...
//   kernel and communities/epistack-competition/corpus; pure over the corpus.
...
const { KINDS, SOURCES } = require("../communities/epistack-competition/corpus/tables.js");
const { STORE } = require("../communities/epistack-competition/corpus/epistack-competition-data.js");
